...
import EcomercePlatformDemoApp.entity.JwtRequest;
import EcomercePlatformDemoApp.entity.JwtResponse;
...
public class JwtService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (user != null) {
            return new org.springframework.security.core.userdetails.User( //takes three parameters
                    user.getUserName(),
